...
<?php
    ...
    if(!$isSyncTZ){
        echo '<div style="color:red">Warning: clock TZ or DST seems out of sync!<p></div>';
    }    
...
?>
<button type="submit" name="toSetupPage" value="procSync<?php echo $mac ?>" id="syncButton">Sync</button>
<?php
